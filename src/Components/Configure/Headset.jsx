...
Command: npx gltfjsx@6.1.4 public/assets/models/Headset.glb --transform
*/
...
export default function Headset(props) {
  const { nodes, materials } = useGLTF('/assets/models/Headset-transformed.glb')
  return (
    <group {...props} dispose={null}>
      <mesh geometry={nodes.Circle.geometry} material={materials.blackplastic} position={[0.94, -1.08, 0]} rotation={[0, 0, 1.08]} />
      <mesh geometry={nodes.Circle004.geometry} material={materials.blackplastic} position={[0.94, -1.08, 0]} rotation={[0, 0, 1.08]} />
      <mesh geometry={nodes.Circle005.geometry} material={materials.Material1} position={[0.93, -1.08, 0]} rotation={[0, 0, 1.08]} />
...
useGLTF.preload('/assets/models/Headset-transformed.glb')
